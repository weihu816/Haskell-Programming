...
> class valid (top :: Color) (l :: Color) (r :: Color) 
...
> balanceL c (HN R E x E) z d			= HN c (N R E x E) z d
...
> balanceR c a x (NH R b y d)			= NH c a x (N B b y d)
> balanceR c a x (HN R E y E)			= NH c a x (N R E y E)
> balanceR c a x (NH R b@(N B _ _ _) y d@(N B _ _ _))
>										= NH c a x (N R b y d)
