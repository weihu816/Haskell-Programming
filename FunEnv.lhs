...
At this point, see if you can extend the interpreter above with better error handling,
using `Either String`, an instance of `MonadError`.

[FunEnvError](FunEnvError.html)
