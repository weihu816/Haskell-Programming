...
* Find your HW #3 partners and sit at new tables

* Download Classes.lhs (this file) from the course website
...
> data Tree a = Leaf | Branch a (Tree a) (Tree a) -- deriving Eq
...
>   Leaf == Leaf = True
>   Branch x t1 t2 == Branch y u1 u2 = t1 == u1 && t2 == u2 && x == y
>   _ == _ = False    
...
in other languages? What about from your mathematics classes?
   ...
   * serialization
   * hashCode
   * truthiness (bool conversion), general conversion
   * iterators
   * comparison
